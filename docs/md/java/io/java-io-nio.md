...
![image-20220719164759898](http://blogs.luckyluo.top:9000/blogimg/d2299e2f-20cf-4cd6-840a-32ef5e55f04b.png)

② 从输入通道中读取 5 个字节数据写入缓冲区中，此时 position 移动设置为 5，limit 保持不变。

![image-20220719164808190](http://blogs.luckyluo.top:9000/blogimg/c7348a6f-cb03-4843-9334-5c6a64d378d7.png)

③ 在将缓冲区的数据写到输出通道之前，需要先调用 flip() 方法，这个方法将 limit 设置为当前 position，并将 position 设置为 0。

![image-20220719164816017](http://blogs.luckyluo.top:9000/blogimg/c65ae2c1-e1df-4170-9d4d-095f385dc069.png)

④ 从缓冲区中取 4 个字节到输出缓冲中，此时 position 设为 4。

![image-20220719164824792](http://blogs.luckyluo.top:9000/blogimg/cd16759e-64e7-4ef6-b988-6fe226421a21.png)

⑤ 最后需要调用 clear() 方法来清空缓冲区，此时 position 和 limit 都被设置为最初位置。

![image-20220719164832398](http://blogs.luckyluo.top:9000/blogimg/5b1c00f4-c42c-4f30-886a-2585a3312235.png)
...
![image-20220719164845742](http://blogs.luckyluo.top:9000/blogimg/e0ac43e5-af25-4bb2-92ac-2453559ce779.png)

...
- Java 15 新特性概述
  - [知识体系](#知识体系)
  - 语言特性增强
    - [JEP 378: 文本块(Text Blocks)](#jep-378-文本块text-blocks)
  - 新功能和库的更新
    - [JEP 339: Edwards-Curve 数字签名算法 (EdDSA)](#jep-339-edwards-curve-数字签名算法-eddsa)
    - [JEP 371: 隐藏类 Hidden Classes](#jep-371-隐藏类-hidden-classes)
    - [JEP 373: 重新实现 DatagramSocket API](#jep-373-重新实现-datagramsocket-api)
  - JVM 优化
    - [JEP 373: ZGC: 可伸缩低延迟垃圾收集器](#jep-373-zgc-可伸缩低延迟垃圾收集器)
    - [JEP 374: 禁用偏向锁定](#jep-374-禁用偏向锁定)
    - [JEP 379: Shenandoah：低暂停时间垃圾收集器(转正)](#jep-379-shenandoah低暂停时间垃圾收集器转正)
  - 旧功能的删除和弃用
    - [JEP 372: 移除Nashorn JavaScript引擎](#jep-372-移除nashorn-javascript引擎)
    - [JEP 381: 移除了 Solaris 和 SPARC 端口。](#jep-381-移除了-solaris-和-sparc-端口)
    - [JEP 385: 废除 RMI 激活](#jep-385-废除-rmi-激活)
  - 新功能的预览和孵化
    - [JEP 375: instanceof 自动匹配模式（第二次预览）](#jep-375-instanceof-自动匹配模式第二次预览)
    - [JEP 360: 密封的类和接口（预览）](#jep-360-密封的类和接口预览)
    - [JEP 383: 外部存储器访问 API（二次孵化器版）](#jep-383-外部存储器访问-api二次孵化器版)
    - [JEP 384: Records (二次预览)](#jep-384-records-二次预览)
  - [总结](#总结)

## 知识体系

![image-20220720100616464](http://blogs.luckyluo.top:9000/blogimg/f48d8613-b5ae-4513-b20e-ff801951e026.png)
...
[Java14中文本块相关介绍  (opens new window)](https://pdai.tech/md/java/java8up/java14.html#文本块第二预览版本)
...
![image-20220720100631410](http://blogs.luckyluo.top:9000/blogimg/74b656f1-dc6b-4521-aa48-8a8cf48d7f27.png)
...
![image-20220720100642666](http://blogs.luckyluo.top:9000/blogimg/d82d6ec5-c786-4a36-8da8-b7aacb70c567.png)
...
![image-20220720100658285](http://blogs.luckyluo.top:9000/blogimg/fef93b22-a2b3-468e-8b64-ac7bc2152498.png)

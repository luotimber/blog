...
- Java 9 新特性概述
  - [知识体系](#知识体系)
  - [Java 平台 模块系统](#java-平台-模块系统)
  - [Jshell](#jshell)
  - [集合、Stream 和 Optional](#集合stream-和-optional)
  - [进程 API](#进程-api)
  - [平台日志 API 和 服务](#平台日志-api-和-服务)
  - [反应式流 （ Reactive Streams ）](#反应式流--reactive-streams-)
  - [变量句柄](#变量句柄)
  - [改进方法句柄（Method Handle）](#改进方法句柄method-handle)
  - [并发](#并发)
  - [Nashorn](#nashorn)
  - [I/O 流新特性](#io-流新特性)
  - [改进应用安全性能](#改进应用安全性能)
...
![image-20220720094659087](http://blogs.luckyluo.top:9000/blogimg/1aad364a-b3e2-4eef-8308-9bda2fe33862.png)
...
- 本文主要转载自 https://developer.ibm.com/zh/articles/the-new-features-of-Java-9/

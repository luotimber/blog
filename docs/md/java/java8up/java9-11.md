...
- Java 8 升Java 11 重要特性必读
  - 升级JDK11概述
    - [JDK 10后版本发布规则？](#jdk-10后版本发布规则)
    - [JDK 8 升级到JDK 11 性能提升多少？](#jdk-8-升级到jdk-11-性能提升多少)
    - [如何更好的理解从JDK 8 到 JDK 11 升级中带来的重要特性？](#如何更好的理解从jdk-8-到-jdk-11-升级中带来的重要特性)
  - 语言新特性
    - [JDK9 - 允许在接口中使用私有方法](#jdk9---允许在接口中使用私有方法)
    - [JDK10 - 局部变量类型推断](#jdk10---局部变量类型推断)
    - [JDK11 - 用于 Lambda 参数的局部变量语法](#jdk11---用于-lambda-参数的局部变量语法)
  - 新工具和库更新
    - [JDK9 - 集合、Stream 和 Optional更新方法](#jdk9---集合stream-和-optional更新方法)
    - [JDK9 - 进程 API (Process Handle)](#jdk9---进程-api-process-handle)
    - [JDK9 - 变量句柄 (Var Handle)](#jdk9---变量句柄-var-handle)
    - [JDK9 - I/O 流新特性](#jdk9---io-流新特性)
...
从规划调度引擎 OptaPlanner 项目对 [JDK 8和 JDK 11 的性能基准测试  (opens new window)](https://www.optaplanner.org/blog/2019/01/17/HowMuchFasterIsJava11.html)进行了对比来看：
...
![image-20220720093536955](http://blogs.luckyluo.top:9000/blogimg/2c1fa774-c819-46a3-80d8-e0c272239639.png)

...
- Java 16 新特性概述
  - [知识体系](#知识体系)
  - 语言特性增强
    - [JEP 394: instanceof 模式匹配（正式版）](#jep-394-instanceof-模式匹配正式版)
    - [JEP 395: Records (正式版)](#jep-395-records-正式版)
  - 新工具和库
    - [JEP 380：Unix-Domain 套接字通道](#jep-380unix-domain-套接字通道)
    - [JEP 390: 对基于值的类发出警告](#jep-390-对基于值的类发出警告)
    - [JEP 392：打包工具（正式版）](#jep-392打包工具正式版)
  ...
  - 提升 OpenJDK 开发人员的生产力
    ...
    - [JEP 357：从 Mercurial 迁移到 Git & JEP 369，迁移到 GitHub](#jep-357从-mercurial-迁移到-git--jep-369迁移到-github)
    - [JEP 386：AlpineLinux 移植 & JEP 388：Windows/AArch64 移植](#jep-386alpinelinux-移植--jep-388windowsaarch64-移植)
  - [参考文章](#参考文章)

## 知识体系

![image-20220720100914277](http://blogs.luckyluo.top:9000/blogimg/8ef1b79d-8099-479e-ae7d-4de9939e5612.png)
...
![image-20220720100935521](http://blogs.luckyluo.top:9000/blogimg/cd6cf889-4056-4d50-90bd-dcc8df459e43.png)
...
![image-20220720100949870](http://blogs.luckyluo.top:9000/blogimg/98ec37da-c8ae-4819-aeb2-c92bf948d92a.png)

...
- ♥JVM相关知识体系详解♥
  - [知识体系](https://www.pdai.tech/md/java/jvm/java-jvm-x-overview.html#知识体系)
  - [学习要点](https://www.pdai.tech/md/java/jvm/java-jvm-x-overview.html#学习要点)
  - [学习文献](https://www.pdai.tech/md/java/jvm/java-jvm-x-overview.html#学习文献)

## 知识体系

![image-20220720111535857](http://blogs.luckyluo.top:9000/blogimg/1ce03c18-ed42-4b64-a4de-21548f9c5674.png)
...
![image-20220720111755866](http://blogs.luckyluo.top:9000/blogimg/a114bab6-6640-4441-8de6-330e4eebb358.png)
...
![image-20220720111808983](http://blogs.luckyluo.top:9000/blogimg/ddf3d866-25c1-4e4b-bac0-3c64076106b0.png)
...
- 调试排错 - Java 内存分析之堆外内存
  - Java 堆外内存分析相对来说是复杂的，美团技术团队的[Spring Boot引起的“堆外内存泄漏”排查及经验总结  (opens new window)](https://tech.meituan.com/2019/01/03/spring-boot-native-memory-leak.html)可以为很多Native Code内存泄漏/占用提供方向性指引。
...
- [Java虚拟机规范（Java SE 8）  (opens new window)](https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-2.html#jvms-2.5)

...
- GC - Java 垃圾回收器之ZGC详解
  ...
  - ZGC调优实践
    - 调优基础知识
      - [理解ZGC重要配置参数](#理解zgc重要配置参数)
      - [理解ZGC触发时机](#理解zgc触发时机)
      - [理解ZGC日志](#理解zgc日志)
      - [理解ZGC停顿原因](#理解zgc停顿原因)
    - 调优案例
      - [案例一：秒杀活动中流量突增，出现性能毛刺](#案例一秒杀活动中流量突增出现性能毛刺)
      - [案例二：压测时，流量逐渐增大到一定程度后，出现性能毛刺](#案例二压测时流量逐渐增大到一定程度后出现性能毛刺)
      - [案例三： 单次GC停顿时间30ms，与预期停顿10ms左右有较大差距](#案例三-单次gc停顿时间30ms与预期停顿10ms左右有较大差距)
      - [案例四：服务启动后，运行时间越长，单次GC时间越长，重启后恢复](#案例四服务启动后运行时间越长单次gc时间越长重启后恢复)
  - 升级ZGC效果
    - [延迟降低](#延迟降低)
    - [吞吐下降](#吞吐下降)
  - [总结](#总结)
...
![image-20220720133222631](http://blogs.luckyluo.top:9000/blogimg/4f5cf730-2338-48cd-9199-6fb334b88614.png)
...
![image-20220720133237771](http://blogs.luckyluo.top:9000/blogimg/7ad842e9-3e32-4e9a-8dab-2304d5e637f2.png)
...
![image-20220720133249869](http://blogs.luckyluo.top:9000/blogimg/8f628380-6573-4f7d-9a40-43b3020c2d4f.png)
...
![image-20220720133303396](http://blogs.luckyluo.top:9000/blogimg/d7ab68ce-bb93-4939-85e5-d1241afc7295.png)
...
![image-20220720133316352](http://blogs.luckyluo.top:9000/blogimg/e45b9335-f9f6-4df3-9600-dfbd9d575d07.png)
...
![image-20220720133333011](http://blogs.luckyluo.top:9000/blogimg/72345af5-b09a-4c60-bbfb-c5ce1e5da8b6.png)
...
![image-20220720133350818](http://blogs.luckyluo.top:9000/blogimg/4723ec4d-47e2-4c1d-ad57-f5d0a09994c9.png)
...
![image-20220720133403620](http://blogs.luckyluo.top:9000/blogimg/e602cc30-dc21-40b7-9d00-b90685ad730f.png)
...
![image-20220720133416732](http://blogs.luckyluo.top:9000/blogimg/8e65a2b6-1af9-4c8b-ad04-d3ddd5224281.png)
...
- [ZGC官网  (opens new window)](https://wiki.openjdk.java.net/display/zgc/Main)
- 彭成寒.《新一代垃圾回收器ZGC设计与实现》. 机械工业出版社, 2019.
- [从实际案例聊聊Java应用的GC优化  (opens new window)](https://tech.meituan.com/2017/12/29/jvm-optimize.html)
- [Java Hotspot G1 GC的一些关键技术  (opens new window)](https://tech.meituan.com/2016/09/23/g1.html)

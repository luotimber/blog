...
- GC - Java 垃圾回收器之CMS GC问题分析与解决
  ...
  - \2. GC 基础
    - [2.1 基础概念](#21-基础概念)
    - [2.2 JVM 内存划分](#22-jvm-内存划分)
    - [2.3 分配对象](#23-分配对象)
    - 2.4 收集对象
      - [2.4.1 识别垃圾](#241-识别垃圾)
      - [2.4.2 收集算法](#242-收集算法)
    - 2.5 收集器
      - [2.5.1 分代收集器](#251-分代收集器)
      - [2.5.2 分区收集器](#252-分区收集器)
      - [2.5.3 常用收集器](#253-常用收集器)
      - [2.5.4 其他收集器](#254-其他收集器)
    - 2.6 常用工具
      - [2.6.1 命令行终端](#261-命令行终端)
      - [2.6.2 可视化界面](#262-可视化界面)
  - \3. GC 问题判断
    - 3.1 判断 GC 有没有问题？
      - [3.1.1 设定评价标准](#311-设定评价标准)
      - [3.1.2 读懂 GC Cause](#312-读懂-gc-cause)
    - [3.2 判断是不是 GC 引发的问题？](#32-判断是不是-gc-引发的问题)
    - 3.3 问题分类导读
      - [3.3.1 Mutator 类型](#331-mutator-类型)
      - [3.3.2 GC 问题分类](#332-gc-问题分类)
      - [3.3.3 排查难度](#333-排查难度)
  - \4. 常见场景分析与解决
    - 4.1 场景一：动态扩容引起的空间震荡
      - [4.1.1 现象](#411-现象)
...
![image-20220720133657543](http://blogs.luckyluo.top:9000/blogimg/f9b59e50-d232-41c0-bad6-60dc5edb4ce2.png)
...
![image-20220720133708780](http://blogs.luckyluo.top:9000/blogimg/5cbbb264-a5b5-44f9-9248-23d291092cf4.png)
...
![image-20220720133722245](http://blogs.luckyluo.top:9000/blogimg/da892a13-b505-444e-a1f8-cd30b311a419.png)

把 mark、sweep、compaction、copying 这几种动作的耗时放在一起看，大致有这样的关系：

![image-20220720133732852](http://blogs.luckyluo.top:9000/blogimg/e3e787cb-115d-4c9e-8a0c-50fdcb8eca81.png)
...
![image-20220720133744471](http://blogs.luckyluo.top:9000/blogimg/d4e2e126-c529-4fce-9e08-bb024175a90a.png)
...
![image-20220720133755656](http://blogs.luckyluo.top:9000/blogimg/4cef1155-2299-4020-8e79-42be0735790b.png)

#### 2.5.3 常用收集器

目前使用最多的是 CMS 和 G1 收集器，二者都有分代的概念，主要内存结构如下：

![image-20220720133809196](http://blogs.luckyluo.top:9000/blogimg/898d295b-5ad3-4ad2-8493-3592a597fe54.png)
...
![image-20220720133820647](http://blogs.luckyluo.top:9000/blogimg/30b042d1-8e71-412e-b3ad-64c426e4ed68.png)
...
![image-20220720133831734](http://blogs.luckyluo.top:9000/blogimg/99e7380b-b182-4f5e-ac11-6d297d29eccf.png)
...
![image-20220720133851289](http://blogs.luckyluo.top:9000/blogimg/decc54ee-ab64-4450-bbbf-28e9533efe24.png)
...
![image-20220720133902190](http://blogs.luckyluo.top:9000/blogimg/aace9839-f61e-4a9a-af1c-2222fe24da98.png)
...
![image-20220720133916644](http://blogs.luckyluo.top:9000/blogimg/ad4c895e-7f0d-4f8d-8a29-401a992e33aa.png)
...
![image-20220720133936213](http://blogs.luckyluo.top:9000/blogimg/ca65cc29-d4af-4a3d-9045-1cd174b386e3.png)
...
![image-20220720133948282](http://blogs.luckyluo.top:9000/blogimg/7cb094ff-3882-44b8-ac3c-65b72216ed35.png)
...
![image-20220720134002604](http://blogs.luckyluo.top:9000/blogimg/784a196e-7056-49ae-8b73-e1e481406045.png)
...
![image-20220720134019361](http://blogs.luckyluo.top:9000/blogimg/fe03b306-b6cb-481a-a924-fd93549d3db2.png)

![image-20220720134026905](http://blogs.luckyluo.top:9000/blogimg/d61e5cbf-79ac-474c-9f90-05b52d438f0e.png)
...
![image-20220720134041532](http://blogs.luckyluo.top:9000/blogimg/d648b81e-cfa6-448e-83c9-e1176f8deaef.png)
...
![image-20220720134056692](http://blogs.luckyluo.top:9000/blogimg/a28c4e1c-035c-40fd-8616-15311d50eaba.png)
...
![image-20220720134107305](http://blogs.luckyluo.top:9000/blogimg/bc277a15-eeaa-46ea-9996-f5272472b5eb.png)
...
![image-20220720134121440](http://blogs.luckyluo.top:9000/blogimg/db8030e5-833e-479e-aaac-0a26943221aa.png)
...
![image-20220720134133120](http://blogs.luckyluo.top:9000/blogimg/1c03b91f-9c95-4d71-a2c1-17453d981ef2.png)
...
![image-20220720134147921](http://blogs.luckyluo.top:9000/blogimg/50539cd0-5c99-4222-b220-b9100f8dd39c.png)
...
![image-20220720134207894](http://blogs.luckyluo.top:9000/blogimg/9ac91c57-4982-438e-9308-5c183a5906bf.png)
...
![image-20220720134219417](http://blogs.luckyluo.top:9000/blogimg/544e83c4-019a-42ef-8017-25cf15b270b9.png)

最终定位到是，项目中对 GIPInputStream 的使用错误，没有正确的 close()。

![image-20220720134229419](http://blogs.luckyluo.top:9000/blogimg/d3638266-051b-4c06-8d0a-f61d15f1e7ec.png)
...
![image-20220720134241281](http://blogs.luckyluo.top:9000/blogimg/e76a1cd5-2fb6-4ff6-94f1-ea6e17130561.png)
...
![image-20220720134256961](http://blogs.luckyluo.top:9000/blogimg/8dc4db25-644e-4587-b4aa-a0384dc2bb66.png)
...
![image-20220720134309793](http://blogs.luckyluo.top:9000/blogimg/80e3b231-6a6e-46e6-a501-856d5a78bdd2.png)
...
![image-20220720134324127](http://blogs.luckyluo.top:9000/blogimg/c95d987a-b329-4c64-adf9-e6f80a85344b.png)
...
![image-20220720134339559](http://blogs.luckyluo.top:9000/blogimg/431ccbca-2dae-43ba-afef-6fe8abac2128.png)

...
![image-20220720112953080](http://blogs.luckyluo.top:9000/blogimg/9d7cc16e-552b-4a25-9465-6aff7903ed77.png)
...
- JVM 基础 - JVM 内存结构
  ...
  - 二、虚拟机栈
    ...
    - 2.4 栈帧的内部结构
      ...
      - 2.4.2. 操作数栈
        - [概述](#概述)
        - [栈顶缓存（Top-of-stack-Cashing）](#栈顶缓存top-of-stack-cashing)
      - 2.4.3. 动态链接（指向运行时常量池的方法引用）
        - [JVM 是如何执行方法调用的](#jvm-是如何执行方法调用的)
        - [虚方法和非虚方法](#虚方法和非虚方法)
        - [虚方法表](#虚方法表)
      - [2.4.4. 方法返回地址（return address）](#244-方法返回地址return-address)
      - [2.4.5. 附加信息](#245-附加信息)
  - 三、本地方法栈
    - [3.1 本地方法接口](#31-本地方法接口)
    - [3.2 本地方法栈（Native Method Stack）](#32-本地方法栈native-method-stack)
  - 四、堆内存
    - 4.1 内存划分
...
![image-20220720113009362](http://blogs.luckyluo.top:9000/blogimg/00bd7358-7b9f-47d1-be0f-3935a4b39736.png)
...
![image-20220720113026567](http://blogs.luckyluo.top:9000/blogimg/2a2962db-f9b0-446f-b659-9aea01c45cb4.png)
...
![image-20220720113042789](http://blogs.luckyluo.top:9000/blogimg/39534f6c-2f3c-4757-9055-abaa435c451e.png)
...
![image-20220720113055295](http://blogs.luckyluo.top:9000/blogimg/a2baaf66-56ff-4468-a6c2-df5ff7bc8ca1.png)
...
![image-20220720113107727](http://blogs.luckyluo.top:9000/blogimg/5c95581b-460d-43d4-b2ca-ad2fef0b13bd.png)
...
![image-20220720113120686](http://blogs.luckyluo.top:9000/blogimg/12410e40-2b31-47c3-b001-eb196eb6816c.png)
...
![image-20220720113138390](http://blogs.luckyluo.top:9000/blogimg/cb596ff6-29fc-4810-87cc-e9619421a120.png)
...
![image-20220720113152875](http://blogs.luckyluo.top:9000/blogimg/9d102c11-a64c-4d1b-8319-25a8de176f09.png)
...
![image-20220720113213198](http://blogs.luckyluo.top:9000/blogimg/6943b788-f060-43c6-8746-fb7e83277e97.png)
...
![image-20220720113230737](http://blogs.luckyluo.top:9000/blogimg/eed538ff-d502-4d56-85d4-6869fa28f061.png)

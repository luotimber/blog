...
- Collection - LinkedList源码解析
  ...
  - LinkedLists实现
    ...
    - [removeFirst(), removeLast(), remove(e), remove(index)](#removeFirst-removelast-removee-removeindex)
    - [add()](#add)
    - [addAll()](#addall)
    - [clear()](#clear)
...
![image-20220715151826467](http://blogs.luckyluo.top:9000/blogimg/7c5d66d3-5312-4b6b-94af-cbead69ce432.png)
...
![image-20220715151845770](http://blogs.luckyluo.top:9000/blogimg/baa205de-c63c-43a0-b879-ac051129a91e.png)
...
![image-20220715151912408](http://blogs.luckyluo.top:9000/blogimg/490fa9f6-a1c3-4278-8dc3-e00e8a48bbab.png)

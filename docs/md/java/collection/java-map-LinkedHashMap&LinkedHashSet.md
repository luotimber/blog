...
![image-20220715165034053](http://blogs.luckyluo.top:9000/blogimg/6fb18bd4-4d93-49c4-b7eb-64135db9d4e7.png)
...
`get(Object key)`方法根据指定的`key`值返回对应的`value`。该方法跟`HashMap.get()`方法的流程几乎完全一样，读者可自行[参考前文  (opens new window)](https://github.com/CarpenterLee/JCFInternals/blob/master/markdown/6-HashSet and HashMap.md#get)，这里不再赘述。
...
![image-20220715165051248](http://blogs.luckyluo.top:9000/blogimg/175bd7c7-7300-4e58-873b-23bf0a98e45f.png)
...
![image-20220715165110334](http://blogs.luckyluo.top:9000/blogimg/959a4c1a-edcc-48d4-b1f5-c342af946db6.png)

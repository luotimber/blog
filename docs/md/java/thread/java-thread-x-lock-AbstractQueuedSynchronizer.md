...
![image-20220719150255738](http://blogs.luckyluo.top:9000/blogimg/2fb92503-3c5e-4268-bdf5-b2fb209e4e6d.png)
...
![image-20220719150321350](http://blogs.luckyluo.top:9000/blogimg/89fd70a3-454c-46e3-a212-418a5b39261b.png)
...
![image-20220719150343870](http://blogs.luckyluo.top:9000/blogimg/30f7ed80-f9e0-4b31-85b9-fdc1fac6ec76.png)
...
![image-20220719150357702](http://blogs.luckyluo.top:9000/blogimg/d1f787e0-d536-49bd-aacf-cd4da170e3e2.png)
...
![image-20220719150407868](http://blogs.luckyluo.top:9000/blogimg/7339c6ba-dd76-4325-8bb8-b720ea0db356.png)
...
![image-20220719150419239](http://blogs.luckyluo.top:9000/blogimg/76792c17-ff03-4554-bced-ccf01400675e.png)

说明: 经过一系列的方法调用，最后达到的状态是禁用t2线程，因为调用了LockSupport.park。

- t1线程调用lock.unlock，其方法调用顺序如下，只给出了主要的方法调用。

![image-20220719150428573](http://blogs.luckyluo.top:9000/blogimg/6b264ce6-771c-4987-82db-5ecf92ae2ebe.png)
...
![image-20220719150438823](http://blogs.luckyluo.top:9000/blogimg/76720316-fed3-4827-9d59-ec411bd290d7.png)
...
![image-20220719150448591](http://blogs.luckyluo.top:9000/blogimg/4a086cd3-7ab1-461f-b0a6-62676006e8f5.png)
...
![image-20220719150505692](http://blogs.luckyluo.top:9000/blogimg/e4b85ac1-f827-4227-aa1f-9ff9f90903ca.png)
...
![image-20220719150514803](http://blogs.luckyluo.top:9000/blogimg/98a6a675-a8b5-4800-b526-8aa7cbf74e8f.png)

说明: p2线程调用lock.lock后，会禁止p2线程的继续运行，因为执行了LockSupport.park操作。

- c1线程调用lock.lock，由前面的分析得到如下的最终状态。

![image-20220719150523500](http://blogs.luckyluo.top:9000/blogimg/34fb9601-87c6-4196-b821-44ebd913f084.png)
...
![image-20220719150532273](http://blogs.luckyluo.top:9000/blogimg/8c1df5bb-5d85-495d-b33a-7a538e7f453c.png)
...
![image-20220719150556622](http://blogs.luckyluo.top:9000/blogimg/ac808977-5ac1-454e-b0b1-7a21b167791e.png)
...
![image-20220719150607602](http://blogs.luckyluo.top:9000/blogimg/b7699647-50c0-4742-9586-1d110161ab42.png)
...
![image-20220719150617879](http://blogs.luckyluo.top:9000/blogimg/3eaa1341-58ba-4bf1-9776-57c51f1b6bb6.png)
...
![image-20220719150627903](http://blogs.luckyluo.top:9000/blogimg/62e1f4d8-5422-4673-80b3-a1384380ad94.png)

说明: 其中，head设置为包含c1线程的结点，c1继续运行。

- c1线程执行fullCondtion.signal，其方法调用顺序如下，只给出了主要的方法调用。

![image-20220719150638229](http://blogs.luckyluo.top:9000/blogimg/6eca10fd-a717-4d03-ba22-eb3cb957c1da.png)
...
![image-20220719150649646](http://blogs.luckyluo.top:9000/blogimg/d2e0264b-e114-44e2-9060-2329f6b80024.png)

说明: 最终c2线程会获取锁资源，继续运行用户逻辑。

- c2线程执行emptyCondition.await，由前面的第七步分析，可知最终的状态如下。

![image-20220719150658782](http://blogs.luckyluo.top:9000/blogimg/16ee822a-cd79-40c1-a79e-4fe97c0ee36c.png)
...
![image-20220719150711275](http://blogs.luckyluo.top:9000/blogimg/f8ec311d-cd20-41c9-a319-eaf32fa2dde4.png)

- p2继续运行，执行emptyCondition.signal，根据第九步分析可知，最终到达的状态如下。

![image-20220719150722301](http://blogs.luckyluo.top:9000/blogimg/ba8b3cea-f1ed-41ea-bcea-30de5bd342e7.png)
...
![image-20220719150731980](http://blogs.luckyluo.top:9000/blogimg/6beb5e1e-2e69-41ee-8088-22d40b6f5a7a.png)

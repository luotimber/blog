...
![image-20220719151620789](http://blogs.luckyluo.top:9000/blogimg/bee1f2f1-8af2-493c-9b7c-94dda1534b41.png)
...
![image-20220719151637643](http://blogs.luckyluo.top:9000/blogimg/7489bb4e-e773-4823-94fc-fa2bbff8f082.png)
...
![image-20220719151651989](http://blogs.luckyluo.top:9000/blogimg/5bab6b16-3154-4c48-aaf9-eb633531420a.png)
...
![image-20220719151705271](http://blogs.luckyluo.top:9000/blogimg/f53d8b39-f7bb-46a9-986c-a3992955678a.png)
...
![image-20220719151721367](http://blogs.luckyluo.top:9000/blogimg/26e38d3f-06e0-4da8-8cf9-0181d8c2f539.png)
...
![image-20220719151743489](http://blogs.luckyluo.top:9000/blogimg/0a8d2b78-e0af-4b21-9618-fa2605797289.png)

- rt1线程执行rrwLock.readLock().lock操作，主要的函数调用如下。

![image-20220719151753194](http://blogs.luckyluo.top:9000/blogimg/91fa8643-65c5-4a9a-9345-d7eb4d5b687e.png)

说明: 此时，AQS的状态state为2^16 次方，即表示此时读线程数量为1。

- rt2线程执行rrwLock.readLock().lock操作，主要的函数调用如下。

![image-20220719151804567](http://blogs.luckyluo.top:9000/blogimg/61d2fdc5-1824-42c9-9bcd-038b3f2bb2fb.png)

说明: 此时，AQS的状态state为2 * 2^16次方，即表示此时读线程数量为2。

- wt1线程执行rrwLock.writeLock().lock操作，主要的函数调用如下。

![image-20220719151814806](http://blogs.luckyluo.top:9000/blogimg/7dd22f80-087f-4b42-8dff-08c5b0228d9a.png)

说明: 此时，在同步队列Sync queue中存在两个结点，并且wt1线程会被禁止运行。

- rt1线程执行rrwLock.readLock().unlock操作，主要的函数调用如下。

![image-20220719151825228](http://blogs.luckyluo.top:9000/blogimg/f22aa819-a032-4f33-9ca7-e79190f0f56d.png)

说明: 此时，AQS的state为2^16次方，表示还有一个读线程。

- rt2线程执行rrwLock.readLock().unlock操作，主要的函数调用如下。

![image-20220719151832607](http://blogs.luckyluo.top:9000/blogimg/b53321a2-b7ac-445f-9727-4f941ffe6a19.png)
...
![image-20220719151841037](http://blogs.luckyluo.top:9000/blogimg/4dca9cd4-4927-4750-83b2-a2630bad87ca.png)
...
![image-20220719151850309](http://blogs.luckyluo.top:9000/blogimg/c8cc0eb7-ecdb-44c8-be29-92c37bbe1a45.png)

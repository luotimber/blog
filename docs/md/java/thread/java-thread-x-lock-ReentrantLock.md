...
![image-20220719151146814](http://blogs.luckyluo.top:9000/blogimg/31c79d14-f2b1-4dc8-a7ed-707263984191.png)
...
![image-20220719151201314](http://blogs.luckyluo.top:9000/blogimg/4cf9b764-38f9-48ff-a6b2-ccf92b70ff22.png)
...
![image-20220719151214853](http://blogs.luckyluo.top:9000/blogimg/40ee7b68-ec5e-40c6-a74b-36007fe21e22.png)
...
![image-20220719151230743](http://blogs.luckyluo.top:9000/blogimg/6edc3f03-6f25-4e51-a1a4-d2ea6b965b19.png)
...
![image-20220719151239341](http://blogs.luckyluo.top:9000/blogimg/33028c32-50c9-4a55-b9e9-de95bf65ee64.png)

说明: 由调用流程可知，t1线程成功获取了资源，可以继续执行。

- t2线程执行lock.lock，下图给出了方法调用中的主要方法。

![image-20220719151249385](http://blogs.luckyluo.top:9000/blogimg/6d3a1bf5-f0cd-4c43-a186-c388bea40ee0.png)

说明: 由上图可知，最后的结果是t2线程会被禁止，因为调用了LockSupport.park。

- t3线程执行lock.lock，下图给出了方法调用中的主要方法。

![image-20220719151259720](http://blogs.luckyluo.top:9000/blogimg/8e809967-2226-47e9-b602-45fcc5677341.png)

说明: 由上图可知，最后的结果是t3线程会被禁止，因为调用了LockSupport.park。

- t1线程调用了lock.unlock，下图给出了方法调用中的主要方法。

![image-20220719151310450](http://blogs.luckyluo.top:9000/blogimg/789746c8-3de0-48c0-be25-e7fd7b5d6070.png)
...
![image-20220719151321613](http://blogs.luckyluo.top:9000/blogimg/b48b9d71-bd36-469d-896e-057803b02ec7.png)
...
![image-20220719151330993](http://blogs.luckyluo.top:9000/blogimg/8030aee8-2e3e-4967-bcdd-b8db1de9224a.png)

说明: 由上图可知，最终unpark t3线程，让t3线程可以继续运行。

- t3线程获取cpu资源，恢复之前的状态，继续运行。

![image-20220719151342944](http://blogs.luckyluo.top:9000/blogimg/4260a93f-eeea-4c75-8d16-08cce4ad0ec2.png)

说明: 最终达到的状态是sync queue中只剩下了一个结点，并且该节点除了状态为0外，其余均为null。

- t3执行lock.unlock，下图给出了方法调用中的主要方法。

![image-20220719151351871](http://blogs.luckyluo.top:9000/blogimg/851e1750-d75f-4ccb-b8f2-6b3100fa34a4.png)

...
- Java 基础 - 异常机制详解
  - 异常的层次结构
    ...
    - [可查的异常（checked exceptions）和不可查的异常（unchecked exceptions）](#可查的异常checked-exceptions和不可查的异常unchecked-exceptions)
  - 异常基础
    - [异常关键字](#异常关键字)
    - [异常的申明(throws)](#异常的申明throws)
    - [异常的抛出(throw)](#异常的抛出throw)
    - [异常的自定义](#异常的自定义)
    - 异常的捕获
      - [try-catch](#try-catch)
  ...
  - 深入理解异常
    - [JVM处理异常的机制？](#jvm处理异常的机制)
    - [异常是否耗时？为什么会耗时？](#异常是否耗时为什么会耗时)
  - [参考文章](#参考文章)
...
![image-20220715143452945](http://blogs.luckyluo.top:9000/blogimg/1630fa61-b2b4-4c40-83fd-648ce7d12423.png)
...
![image-20220715143520086](http://blogs.luckyluo.top:9000/blogimg/592ca4b5-f19f-4285-9628-d12b41d9828b.png)

...
这里我们发现通过注解的方式，我们实现单元测试时将更为优雅。如果你还期望了解Junit4是如何实现运行的呢？可以看这篇文章：[JUnit4源码分析运行原理  (opens new window)](https://blog.csdn.net/weixin_34043301/article/details/91799261)。

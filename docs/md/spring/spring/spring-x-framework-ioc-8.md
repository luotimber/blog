---
title: Spring进阶 - SpringMVC实现原理之DispatcherServlet的初始化过程
date: 2021-12-20
tags:
- Spring
- SpringMVC
...
- Spring进阶 - SpringMVC实现原理之DispatcherServlet的初始化过程
  - [DispatcherServlet和ApplicationContext有何关系？](#dispatcherservlet和applicationcontext有何关系)
...
> DispatcherServlet 作为一个 Servlet，需要根据 Servlet 规范使用 Java 配置或 web.xml 声明和映射。反过来，DispatcherServlet 使用 Spring 配置来发现请求映射、视图解析、异常处理等等所需的委托组件。那它和ApplicationContext有和关系呢？如下内容可以参考[官网-SpringMVC文档  (opens new window)](https://docs.spring.io/spring-framework/docs/current/reference/html/web.html#mvc-servlet)
...
![image-20220714162645313](http://blogs.luckyluo.top:9000/blogimg/0407c4eb-678d-4a61-af81-22482d8e28c7.png)
...
![image-20220714162658469](http://blogs.luckyluo.top:9000/blogimg/97ca0768-c2d9-4efc-8f83-992406fcf84e.png)



很容易找到init()的方法位于HttpServletBean中，然后跑[Spring基础 - SpringMVC请求流程和案例](https://www.pdai.tech/md/spring/spring-x-framework-springmvc.html)中的代码，在init方法中打断点。

![image-20220714162711896](http://blogs.luckyluo.top:9000/blogimg/3bc7c166-0515-46ac-b033-d76564316928.png)
...
![image-20220714162730555](http://blogs.luckyluo.top:9000/blogimg/2a5134d9-868d-421b-b360-b03940d36c75.png)
...
initHandlerMapping方法如下，无非就是获取按照优先级排序后的HanlderMappings, 将来匹配时按照优先级最高的HanderMapping进行处理。](http://blogs.luckyluo.top:9000/blogimg/d2b36343-e248-44d5-829c-cd60fcb8eace.png)

![image-20220714162816464](http://blogs.luckyluo.top:9000/blogimg/71a87468-d4ed-48c2-87fd-cee8b5d4ef66.png)
